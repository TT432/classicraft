...
public class AttachFoods {
    static final Map<Item, FoodProperties> MAP = ImmutableMap.<Item, FoodProperties>builder()
            .put(Items.ROTTEN_FLESH, food(0, 0.0)
                    .effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 900, 3), 1)
                    .effect(() -> new MobEffectInstance(MobEffects.HUNGER, 900, 2), 1)
                    .effect(() -> new MobEffectInstance(MobEffects.WEAKNESS, 900, 1), 1).build())
            ...
            .put(Items.SUGAR, food(1, 0.6)
                    .effect(() -> new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 80, 1), 1).build())
            .put(Items.FERMENTED_SPIDER_EYE, food(4, 6.4)
                    .effect(() -> new MobEffectInstance(MobEffects.WEAKNESS, 80, 1), 1).build())
            .put(Items.EGG, food(2, 0.4).build())
            .put(Items.TURTLE_EGG, food(2, 0.4).build())
            .put(Items.BROWN_MUSHROOM, food(1, 0.2)
                    .effect(() -> new MobEffectInstance(MobEffects.WEAKNESS, 300, 3), 1)
                    .effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 300, 2), 1).build())
            .put(Items.RED_MUSHROOM, food(1, 0.2)
                    .effect(() -> new MobEffectInstance(MobEffects.POISON, 1200, 4), 1)
                    .effect(() -> new MobEffectInstance(MobEffects.WITHER, 600, 1), 1).build())
